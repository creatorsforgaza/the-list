...
chuffed_links <- tibble(
  ...
  link_text = c("Mohammed and his wife",
                ...
                "Nedaa Oweida + family"),
  total_num_donations = c(NA, NA, NA, NA, NA, NA),
  currency_abv = c("USD", "USD", "USD", "USD", "USD", "EUR"),
  amount_raised_num = c(NA, NA, NA, NA, NA, NA),
  percent_of_goal = c(11.163, 75.58, 73.20, 59.55, 33.01, 8.83),
  daily_change = c(NA, NA, NA, NA, NA, NA)
)
