...
chuffed_links <- tibble(
  ...
  link_text = c("Mohammed and his wife",
                ...
                "Rahma and Family"),
  total_num_donations = c(NA, NA, NA, NA),
  currency_abv = c("USD", "USD", "USD", "USD"),
  amount_raised_num = c(NA, NA, NA, NA),
  percent_of_goal = c(1.93, 2.9, 7.6, 31),
  daily_change = c(NA, NA, NA, NA)
)
