...
chuffed_links <- tibble(
  ...
  currency_abv = c("USD", "USD", "USD", "USD", "EUR", "USD", "EUR", "USD", "USD"),
  amount_raised_num = c(NA, NA, NA, NA, NA, NA, NA, NA, NA),
  percent_of_goal = c(13.07, 85.51, 94.30, 92.75, 18.01, 50.32, 25.75, 4.52, 0.01),
  daily_change = c(NA, NA, NA, NA, NA, NA, NA, NA, NA)
) %>% 
