...
chuffed_links <- tibble(
  ...
  currency_abv = c("USD", "USD", "USD", "USD", "USD", "EUR", "USD", "EUR"),
  amount_raised_num = c(NA, NA, NA, NA, NA, NA, NA, NA),
  percent_of_goal = c(12.56, 100.47, 80.40, 66.30, 75.34, 11.18, 20.40, 2.37),
  daily_change = c(NA, NA, NA, NA, NA, NA, NA, NA)
) %>% 
