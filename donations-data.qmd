...
final_table %>% 
  ...
  gt::cols_label(
    ...
    total_num_donations_24_hours = paste0("# of donations since ",format(lubridate::now(), "%B %d, %I:%M %p %Z")),
    money_raised_24_hours = paste0("Amount raised since ",format(lubridate::now(), "%B %d, %I:%M %p %Z")),
    row_n = "QR Code",
