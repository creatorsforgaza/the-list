...
daily_numbers <- sheet_gaza_data %>% 
  dplyr::filter(date > today() - days(6)) %>% 
...
chuffed_links <- tibble(
  link = c("https://chuffed.org/project/artistmohammedalassar",
           ...
           "https://chuffed.org/project/supporting-ibrahim-and-his-family",
           "https://chuffed.org/project/177348-contribute-to-changing-salams-life-by-supporting-her-education-and-career",
           "https://gogetfunding.com/help-my-family-in-gaza-to-live-a-dignified-life/",
           "https://chuffed.org/project/185552-help-rawaa-become-a-dentist-triumph-over-war-and-destruction",
           "https://chuffed.org/project/sawsanq"),
  link_text = c("Mohammed and his wife",
                ...
                "Nedaa Oweida + family",
                "Maryam and Family",
                "Help Ibrahim rebuild",
                "Changing the lives of Sohad and Salam from Gaza",
                "Batoul + newborn baby",
                "Help Rawaa become a Dentist",
                "Support Sawsan and her family"),
  # total_num_donations = c(NA, NA, NA, NA, NA, NA, NA),
  currency_abv = c("USD", "USD", "USD", "EUR", "USD", "EUR", "USD", "USD", "EUR", "USD"),
  amount_raised_num = c(NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
  percent_of_goal = c(13.07, 85.51, 94.30, 18.01, 50.32, 25.75, 4.52, 0.01, 1.93, 41.60),
  daily_change = c(NA, NA, NA, NA, NA, NA, NA, NA, NA, NA)
) %>% 
  dplyr::arrange(percent_of_goal)
